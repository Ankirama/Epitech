/*
** my_env.c for my_env in /home/mar_b/rendu/PSU_2013_minishell1
**
** Made by mar_b mar_b
** Login   <mar_b@epitech.net>
**
** Started on  Tue Jun 17 03:46:42 2014 mar_b mar_b
** Last update Sun Jun 22 19:47:15 2014 mar_b mar_b
*/
...
char	my_env_opt(t_list *env, char **var)
{
  ...
  while (++i < 5)
    opt[i] = 0;
  out = _my_check_opt_env(env, &var[1], &opt[0], 0);
  if (out == -1)
    return (-1);
  else if (out > 0)
