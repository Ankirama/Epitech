/*
** my_va_base_long.c for my_va_base_long in /home/user/rendu/PSU_2013_my_printf
**
** Made by 
** Login   
**
** Started on  Sat Apr 19 19:05:34 2014 
** Last update Sun Apr 20 22:23:33 2014 
*/
...
*/
int			my_putnbr_base_oct_long(va_list *ap,
						t_flag_opt *flag_opt)
{
  char			*base;
...
*/
int			my_putnbr_base_bin_long(va_list *ap,
						t_flag_opt *flag_opt)
{
  char			*base;
  unsigned long int	nbr;
...
*/
int			my_putnbr_base_hex_M_long(va_list *ap,
					  t_flag_opt *flag_opt)
{
  char			*base;
  unsigned long int	nbr;
