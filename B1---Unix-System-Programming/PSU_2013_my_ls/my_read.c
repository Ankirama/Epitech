/*
** my_read.c for my_read in /home/user/rendu/PSU_2013_my_ls
**
** Made by 
** Login   
**
** Started on  Sun Apr 27 21:21:52 2014 
** Last update Fri May  2 19:35:52 2014 
*/
...
char	my_help()
{
  my_printf("Usage : ./my_ls [-aBlRdrtFfgGoS] [FILES]\n\n");
  my_printf("-a: \tdo not ignore entries starting with .\n");
  my_printf("-B: \tdo not list implied entries ending with ~\n");
  my_printf("-d: \tlist directory entries instead of contents\n");
  my_printf("-f: \tdo not sort, enable -a and disable color\n");
  my_printf("-F: \tappend indicator (one of */=@|) to entries\n");
  my_printf("-g: \tlike -l, but do not list owner\n");
  my_printf("-G: \tin a long listing, don't print group names\n");
  my_printf("-l: \tuse a long listing format\n");
  my_printf("-o: \tlike -l, but do not list group information\n");
  my_printf("-r: \treverse order while sorting\n");
  my_printf("-R: \tlist subdirectories recursively\n");
  my_printf("-S: \tsort by file size\n");
