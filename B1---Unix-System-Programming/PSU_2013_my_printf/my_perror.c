/*
** my_perror.c for my_perror.c in /home/user/rendu/Piscine-C-Jour_13/cat
**
** Made by 
** Login   
**
** Started on  Wed Mar 26 14:53:32 2014 
** Last update Thu Apr 17 16:24:19 2014 
*/
...
{
  if (i > 133 || i < 0)
    return (write(1, "Unknown error ", 14) + my_putnbr(i));
  write(1, g_my_tab[i], my_strlen(g_my_tab[i]));
  return (0);
}
