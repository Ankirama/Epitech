//
// koaladoctorlist.cpp for meow in /home/user/rendu/piscine_cpp_d06/ex05
//
// Made by 
// Login   
//
// Started on  Mon Jan 12 17:45:04 2015 
// Last update Tue Jan 13 00:51:11 2015 
//
...
KoalaDoctor *KoalaDoctorList::getFromName(std::string name) {
  ...
  while (tmp != NULL && ((tmp->_doctor != NULL && tmp->_doctor->getName() != name) || tmp->_doctor == NULL))
    tmp = tmp->_next;
  return (tmp != NULL && tmp->_doctor != NULL ? tmp->_doctor : NULL);
}
