//
// koalanurselist.cpp for meow in /home/user/rendu/piscine_cpp_d06/ex05
//
// Made by 
// Login   
//
// Started on  Mon Jan 12 16:30:54 2015 
// Last update Tue Jan 13 01:20:21 2015 
//
...
KoalaNurse *KoalaNurseList::getFromID(int id) {
  ...
  while (tmp != NULL && ((tmp->_nurse != NULL && tmp->_nurse->getID() != id) || tmp->_nurse == NULL))
    tmp = tmp->_next;
  return (tmp != NULL ? tmp->_nurse : NULL);
}
