//
// sickkoalalist.cpp for list in /home/user/rendu/piscine_cpp_d06/ex05
//
// Made by 
// Login   
//
// Started on  Mon Jan 12 13:58:43 2015 
// Last update Tue Jan 13 01:20:29 2015 
//
...
SickKoala *SickKoalaList::getFromName(std::string name) {
  ...
  while (tmp != NULL && ((tmp->_koala != NULL && tmp->_koala->getName() != name) || tmp->_koala == NULL))
    tmp = tmp->_next;
  return (tmp != NULL ? tmp->_koala : NULL);
}
