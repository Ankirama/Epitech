/*
** my_str_ap.c for my_str_ap in /home/user/rendu/PSU_2014_my_printf
**
** Made by 
** Login   
**
** Started on  Mon Apr 14 20:10:12 2014 
** Last update Sun Apr 20 16:52:22 2014 
*/
...
int	my_putstr(va_list *ap, t_flag_opt *flag_opt)
{
  ...
  if (!flag_opt->minus && (flag_opt->zero != 0 || flag_opt->number != 0))
    ...
    {
      space_zero += my_write(g_fd, str, my_strlen(str));
      space_zero += my_add_space_zero(my_strlen(str),
  ...
  my_init_opt(flag_opt);
  return (space_zero + my_write(g_fd, str, my_strlen(str)));
}
